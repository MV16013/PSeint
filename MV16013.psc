...
Algoritmo Ejercicio_11
	...
	membresia=" "
	TipoMembresia=0
	DescuentoA=10//El valor es entero porque el signo de porcentaje es un simbilo reservado
	DescuentoB=15//El valor es entero porque el signo de porcentaje es un simbilo reservado
	DescuentoC=20//El valor es entero porque el signo de porcentaje es un simbilo reservado
